...
const LoginPage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black p-6">
      ...
      <div className="bg-black p-8 rounded-lg w-full max-w-md shadow-md border-2 border-[#0F9B99] mt-6">
        ...
        <div className="mt-5 pt-5 flex justify-center border-t border-gray-800 text-sm text-gray-400">
